...
-- UPDATE public.users SET is_admin = true, is_verified = true WHERE username = 'Edredm3';
...
alter publication supabase_realtime add table public.posts, public.comments, public.likes, public.notifications;
